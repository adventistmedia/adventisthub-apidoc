...
title<br> *string* | Activity title | Read-only
subject<br> *string* | A title for an associated record if applicable.
...
status<br> *enum* {todo, completed} | Whether activity needs to be done or is completed | Required
...
\**** The following activity types are auto-generated and cannot be created. {event_attendance, email_marketing, sms_marketing}
